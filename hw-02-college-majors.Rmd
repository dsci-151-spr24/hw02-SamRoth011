...
I chose $5,000 because it more smoothly showed the medians.
...
4.  Based on the shape of the histogram you created in the previous exercise, determine which of these summary statistics is useful for describing the distribution.
    ...
    The histogram peaked at $35,000, with a sharp decrease before it and a less sharp decrease after it. There is also a number of observations above $100,000. The median summary statistic seems closest to the graph.
...
ggplot(college_recent_grads, aes(median, sharewomen, color = major_type)) +
  geom_point()

```
This shows that women tend to major in non-stem fields, but women in stem fields make more money.
